...
TC_7.6 Verify return to basket when clicking "Cancel" on confirm dialog

8. TS_8 Account Page

TC_8.1 Positive login to Account page

9. TS_9 Checkout Process
TS_9.1 Checkout Page Load

TC_9.1.1 Verify the checkout page is accessible

TC_9.1.2 Verify the page displays all basket items

TS_9.2 Completing Checkout

TC_9.2.1 Enter valid payment and shipping details

TC_9.2.2 Add shipping costs

TC_9.2.3 Verify checkout was successful
